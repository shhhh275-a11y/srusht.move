    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .hero-glow {
            position: absolute; inset: 0;
            background:
                radial-gradient(ellipse at 65% 35%, rgba(229,9,20,0.18) 0%, transparent 55%),
                radial-gradient(ellipse at 25% 75%, rgba(255,107,53,0.1) 0%, transparent 45%);
        }
        .hero-film-strip {
            position: absolute; top: 0; right: 0; bottom: 0;
            width: 55%;
            background: linear-gradient(to left, transparent 0%, var(--bg) 100%);
            z-index: 1;
        }
        .hero-poster {
        ...
        .hero-title {
            font-family: 'Bebas Neue', sans-serif;
            font-size: 4.2em; line-height: 0.95;
        ...
        .hero-desc {
            color: #aaa; font-size: 0.95em; line-height: 1.75;
        ...
        .btn-watch:hover { background: rgba(255,255,255,0.85); }
        .btn-more {
            display: inline-flex; align-items: center; gap: 10px;
...
<section class="hero" id="heroSec">
    ...
    <div class="hero-content">
        <div class="hero-badge"><i class="fas fa-fire"></i>&nbsp; فیلمی هەفتە</div>
        <h1 class="hero-title" id="heroTitle">FIGHT CLUB</h1>
        <div class="hero-meta">
            <span class="hero-rating-big">⭐ 8.8/10</span>
            <span>1999</span>
            <span>139 خولەک</span>
            <span>R (18+)</span>
        </div>
        <p class="hero-desc" id="heroDesc">کارمەندێکی بێ هیمن لەگەڵ فرۆشیاری سابونێک کۆمەڵێکی شەڕ نهێنی دادەمەزرێنن — بەڵام ئەو چیرۆکە زیاتر لەوەیە کە بیری لێ دەکەیتەوە.</p>
        <div class="hero-btns">
            <button class="btn-watch" onclick="openModal(0)"><i class="fas fa-info-circle"></i> زانیاری تەواو</button>
            <a href="https://www.instagram.com/lipri_26" class="btn-more" target="_blank"><i class="fab fa-instagram"></i> ئینستاگرام</a>
        </div>
    </div>
...
(function setupHero() {
    const m = MOVIES[0];
    document.getElementById('heroPoster').style.backgroundImage = `url('${m.backdrop}')`;
})();
