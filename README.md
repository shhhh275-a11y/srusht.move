...
.watch-btn{
  display:flex;align-items:center;justify-content:center;gap:10px;
  background:linear-gradient(135deg,#1a7a2e 0%,#0d4d1a 100%);
  color:#fff;border-radius:11px;
  padding:13px;font-size:.92em;font-weight:800;
  font-family:'Cairo',sans-serif;width:100%;margin-bottom:10px;
  box-shadow:0 4px 22px rgba(0,180,50,.4);transition:all .22s;
  letter-spacing:.4px;text-decoration:none;
}
.watch-btn:hover{transform:translateY(-2px);box-shadow:0 8px 30px rgba(0,180,50,.6)}
.watch-btn i{font-size:1.1em}
...
function openM(id){
  ...
  document.getElementById('mBox').innerHTML=`
    ...
    <div class="modal-body">
      ...
      ${m.watch?`<a class="watch-btn" href="${m.watch}" target="_blank"><i class="fas fa-play-circle"></i> سەیری فیلم بکە لە کوردسەبتایتڵ</a>`:''}
