بەخێربێت! من کێشەکەم چارەسەر کرد و 20 فیلمی تر زیاد کردم بە هەمان شێوە. وێنەکانی Fight Club و Joker ڕاستکرانەوە و ئێستا کاردەکەن.
...
1. Fight Club و Joker - وێنەکانیان ڕاستکرایەوە و ئێستا کاردەکەن.
2. زیادکردنی 20 فیلمی تر - کۆی گشتی بووە 40 فیلم (لە نێویاندا The Dark Knight, The Godfather, Pulp Fiction, The Matrix, Schindler's List, Whiplash, Django و هتد).
3. باشترکردنی سیستم - بۆ نمایشکردنی هەموو فیلمەکان بە وێنەی کارا.

ئێستا وێنەی هەموو فیلمەکان کاردەکەن و هیچ فیلمێک وێنەی نییە نەماوە. تکایە تاقی بکەرەوە!
